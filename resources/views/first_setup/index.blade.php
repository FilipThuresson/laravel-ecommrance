<x-auth-layout>
    ...
    <div class="card card-border border-base-300 bg-base-100 card-sm overflow-hidden">
        <form action="{{ route('first_setup.store') }}" method="post">
            @csrf
            <div class="card-body gap-4">
                <div class="flex flex-col gap-1"><label class="input input-border flex max-w-none items-center gap-2">
                        ...
                        <input type="text" name="name" class="grow" placeholder="name"></label>
                </div>
                <div class="flex flex-col gap-1"><label class="input input-border flex max-w-none items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                             class="h-4 w-4 opacity-70">
                        ...
                        <input type="text" name="email" class="grow" placeholder="email"></label>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    <label class="input input-border flex max-w-none items-center gap-2">
                        ...
                        <input type="password" name="password_confirmation" class="grow" placeholder="Confirm password">
                    </label>
                </div>
                @if($errors->any())
